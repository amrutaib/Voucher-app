...
export default function CustomField() {
    ...
    const deleteFieldFooter = (
        <React.Fragment>
            <Button label="Cancel" severity='secondary' outlined onClick={hideDeleteField} />
            ...
            <Box
                ...
                <Stack spacing={3} direction={"row"} mb={3}>
                    ...
                    <FormControl fullWidth error={!!fieldNameError}>
                        ...
                        />
                        {fieldNameError && <span style={{ color: 'red', marginTop: 10 }}>{fieldNameError}</span>}
                    </FormControl>
                    ...
                    <FormControl fullWidth error={!!fieldTypeError}>
                        ...
                        />
                        {fieldTypeError && <span style={{ color: 'red', marginTop: 10 }}>{fieldTypeError}</span>}
                    </FormControl>
                    ...
                    <div className="card">
                        {loading ? (<Loader />) : (
                            ...
                            <DataTable
                                ...
                                header={<Header title={`Manage custom form fields`} onSearch={handleSearch} />}
                            ...
                            >
                                ...
                                <Column field="fieldName" header="Field Name" style={{ minWidth: '8rem' }} />
                                <Column field="fieldType" header="Field Type" style={{ minWidth: '8rem' }} />
                                <Column header="Action" body={formActions} style={{ minWidth: '8rem' }} />
                            </DataTable>
